...
export default function Skill() {
    ...
    const skills = [
        { name: t('CPP'), icon: CPP, percentage: '70%' },
        { name: t('JavaScript'), icon: Js, percentage: '75%' },
        { name: t('TypeScript'), icon: Ts, percentage: '75%' },
        ...
        { name: t('Nextjs'), icon: NextjsIcon, percentage: '80%' },
        { name: t('MongoDB'), icon: Mongodb, percentage: '60%' },
        { name: t('Git'), icon: GitIcon, percentage: '90%' },
        { name: t('WordPress'), icon: WordPress, percentage: '95%' },
        { name: t('Canva'), icon: Canva, percentage: '95%' },
