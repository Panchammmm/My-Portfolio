...
export default function Dp() {
    return (
        <>
            <section id="Home" className="lg:w-[85%] w-[90%] mx-auto lg:pt-8 lg:pb-20 lg:mb-14">

                <div className="absolute lg:top-1/2 lg:left-1/2 left-[52%] top-[20%] transform lg:-translate-x-[100%] lg:-translate-y-[100%] -translate-x-[0%] -translate-y-[100%] -z-20">
                ...
                <div className="grid grid-cols-[repeat(auto-fit,minmax(277px,1fr))] gap-y-8 items-center">
                    ...
                    <div>
                        <div className="images mx-auto lg:w-[60%] w-[75%]">
